...
namespace NovaKidsControl.Domain.Entities
{
    ...
    {
        public Professor(int id, string name, string data, string horaEntrada, string horarioKids, string matricula) : base(id, name, data, horaEntrada, horarioKids, matricula)
        {
        }
